...
public class WeatherRequest {
    ...
    public static Observable<CitySearchResponseEntity> doSearchCity(String city) {
    ...
    public static Observable<CityWeatherResponseEntity> doGetWeatherNow(String city) {
        Map<String, String> map = new HashMap<>();
        map.put("key", Constant.HEWEATHER_KEY);
        map.put("city", city);
        return NetworkManager.getCommonClient(Constant.BASE_URL)
